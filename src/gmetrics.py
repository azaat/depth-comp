...
def evaluate_depth(depth_gt_in, depth_pred_in, 
    ...
    errs = compute_errors(depth_pred,depth_gt,distances_to_compute)
            
    # minimize the least squares error and compute the errors again
    scale = compute_depth_scale_factor(depth_pred,depth_gt, depth_scaling=depth_scaling)
    depth_pred_scaled = depth_pred*scale
            
    errs_pred_scaled = compute_errors(depth_pred_scaled,depth_gt,distances_to_compute)
            
    return errs, errs_pred_scaled, scale
